...
class AStarHeuristic :
    ...
    def explore( self ):
        ...
        if start_position[0] >= self.map.shape[0] / 2 :
            # Initially choosing to only expland down and left
            initial_expand_directions = [(1,0),(0,-1),(0,1)]

            # When we reach the bottom of the map we will change the expand up, down, left, right.
            full_expand_directions = [(-1,0), (0,-1), (1,0), (0,1)]
        else :
            # Initially choosing to only expland down and left
            initial_expand_directions = [(-1,0),(0,-1),(0,1)]
        ...
        expand_directions = initial_expand_directions 
        ...
        while len(open_list) > 0 :
            ...
            # Check if we have reach the bottom of the grid or we have reached the top
            # of the grid
            if v.position[0] == self.map.shape[0]-1 or v.position[0] == 0 :
                expand_directions = full_expand_directions
