...
# class book to managing all the books in the library
class Book:
    # Book constructor to initialize book object
...
# class Student
class Student:
    # Student Constructor to initialize student variable
