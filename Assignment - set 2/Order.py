...
#class Order
class Order:
    # Cunstructor Order for initializing order object instance
    ...
    # for ordering the item and calculate total weight and price
...
# class OrderItem for order any perticuler item and its quantity
class OrderItem:
...
# class Item for catelogue with its price and weight
class Item:
